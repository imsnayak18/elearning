...
<body>
	<div class="container-fluid" style="height:100px ">
		...
		<div class="col-sm-6 col-lg-3" style="position:relative; top:25%; right:5%; ">
			<button id="Courses" type="button" style=" float:right; margin-right:10px " class="btn btn-lg btn-success">Courses</button>		</div>
		</div>
		<div class="container">
			<div class="panel panel-default" style="background-color:#FFFF;">
				...
				<div class="panel-boby">
					<img id="profilepic"  src="/miniproject/img/sak.jpg"
